...
if (mode === "after-collect") {
  if (!Number.isFinite(beforeMs)) fail("pre-collection generated_at is missing or invalid");
  if (afterMs <= beforeMs) fail(`generated_at did not advance: before=${before} after=${after}`);
