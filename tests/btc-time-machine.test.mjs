...
test('future dates are unavailable and never substituted',()=>{const rows=buildDateRows(dataset,'12-31','2026-08-25',2027);assert.equal(rows[0].status,'future');assert.equal(rows[0].priceUSD,null);});
